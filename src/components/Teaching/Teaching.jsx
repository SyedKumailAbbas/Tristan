        ...
        <div className="flex-1 text-white">
          <h1 className="text-4xl lg:text-5xl font-bold mb-6 leading-tight">
            ...
            MY <span className="relative inline-block">
              <span className="text-yellow-400 relative z-10 font-serif italic text-5xl" style={{ fontFamily: 'cursive' }}>Heart</span>
          ...
          <p className="text-gray-300 mb-8 text-lg leading-relaxed max-w-md">
            "It's important to carry the knowledge and wisdom 
            of someone older but to dream like a child who 
            doesn't yet know what they can't do, 

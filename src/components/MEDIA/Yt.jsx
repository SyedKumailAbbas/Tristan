...
import Vid from "D:/Tristan/src/components/Testimonial/Vid.jsx"; // import the YouTube player component
        ...
        >
            ...
            <div className="flex justify-center">
                <div className="w-full max-w-xl aspect-video rounded-xl overflow-hidden shadow-lg">
                    <Vid videoId="dQw4w9WgXcQ" /> {/* Replace with your actual YouTube videoId */}
                </div>
            </div>
            ...
            <div className="flex flex-col justify-center items-center space-y-6 text-center">
                <p className="text-white font-[Poppins] font-semibold text-[18px] leading-relaxed max-w-lg">
                    Tristan was invited to be a panelist at Toronto Metropolitan University
                    to support first-year students with guidance on involvement, direction,
                    and navigating the student experience. He took the initiative to
                    document and expand the reach of this experience through a YouTube
                    video, aimed at helping students across campuses.
                </p>

    ...
    <div className="bg-gradient-to-r from-[#FFAE00] to-[#000000] text-white p-10">
      <div className="flex justify-between items-center max-w-7xl mx-auto">
        <div className="space-y-4 max-w-md">
          <h1 className="text-3xl font-bold tracking-[0.5%] uppercase" style={{ fontFamily: "Montserrat", fontWeight: 700, lineHeight: "100%" }}>
            Tristan’s Podcast That Helps You Step Into Your{" "}
            <img src={LimitlessLogo} alt="LimitLess Logo" className="inline-block h-13 ml-2" />
          </h1>
          <p className="text-sm">
        ...
        <button className="fixed top-[90%] left-[13%] transform -translate-x-1/2 -translate-y-1/2 px-6 py-2 rounded-full bg-[#6E530C] text-white flex items-center gap-3 shadow-[0px_4px_4px_0px_#FFBD52] hover:cursor-pointer focus:outline-none">

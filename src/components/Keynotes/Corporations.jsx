  ...
  return (
    <div className="relative min-h-screen overflow-hidden">
      ...
      <section className="mx-auto max-w-7xl px-6 py-12 grid gap-10 lg:grid-cols-[520px,1fr] items-center">
        ...
        {/* Right: content card */}
        <div className="backdrop-blur-sm rounded-2xl p-8 lg:p-10 text-gray-100">
          <p className="font-[Poppins] font-semibold text-[17.7px] text-center leading-relaxed max-w-2xl mx-auto">
             In today’s fast-paced world, teams need more than productivity hacks... they need purpose,  perspective, and people-first leadership. These keynotes inspire organizations to elevate culture,  reframe challenges, and perform with clarity and intention.
          </p>

          <ol className="mt-8 space-y-6">
            <li>
              <h3 className="font-[Poppins] font-bold text-[17.7px] text-white">
              ...
              <div className="mt-2 flex gap-3">
                ...
                <p className="font-[Poppins] font-medium text-[15px] text-gray-200">
